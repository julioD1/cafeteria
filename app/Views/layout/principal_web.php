...
<html lang="zxx" dir="ltr">
    ...
    <head>
        ...
        <title>Café Emporium | <?php echo $this->renderSection('titulo') ?></title>
                            ...
                            <div class="item active">
                                <div class="carousel-caption">
                                    <div class="fadeUp item_img">
                                        <img src="<?php echo site_url('web/'); ?>src/assets/img/photos/cafe.png" alt="sample" /> 
                                        <div class="item_badge">
                                            <span class="badge_btext">10%</span>
                                            <span class="badge_stext">OFF</span>
                                        </div>
                                    </div>
                                    <div class="fadeUp fade-slow item_details">
                                        <h4 class="item_name">Café Emporium</h4>
                                        <p class="item_info">Atenção, atenção! Tem oferta passando pela
Café Emporium! Todas os cafés com 10 % de desconto!
Mas aproveite porque é só essa semana! 
Preços imbatíveis é só na Café Emporium!</p>
                                        <div class="item_link_box">
                                            <a href="#reservation" class="item_link page-scroll"> Faça sua reserva</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="carousel-caption">
                                    <div class="fadeUp item_img">
                                        <img src="<?php echo site_url('web/'); ?>src/assets/img/photos/bolo.png" alt="sample" />
                                        <div class="item_badge">
                                    ...
                                    <div class="fadeUp fade-slow item_details">
                                        <h4 class="item_name">Café Emporium</h4>
                                        <p class="item_info">Para, para tudo! Aqui na Café Emporium você vai comprar qualquer bolo com 20% de desconto!
Não é brincadeira! A Cafeteria está com esse descontão.
Venha logo aproveitar e levar o que tem de melhor.</p>
                                        <div class="item_link_box">
                                            <a href="#reservation" class="item_link page-scroll">Faça sua reserva</a>
                                        </div>
                                    </div>
                            ...
                            <div class="item">
                                <div class="carousel-caption">
                                    <div class="fadeUp item_img">
                                        <img src="<?php echo site_url('web/'); ?>src/assets/img/photos/pao.png" alt="sample" />
                                        <div class="item_badge">
                                    ...
                                    <div class="fadeUp fade-slow item_details">
                                        <h4 class="item_name">Café Emporium</h4>
                                        <p class="item_info">Deu a louca no gerente! Somente essa semana todos nossos pães está com 15 % de 
desconto! Isso mesmo que você ouviu, todos nossos pães
com descontos imperdíveis! Você não vai querer ficar de fora dessa!</p>
                                        <div class="item_link_box">
                                            <a href="#reservation" class="item_link page-scroll">Faça sua reserva </a>
                                        </div>
                                    </div>
                    ...
                    <div class="navbar-container" data-spy="affix" data-offset-top="400">
                        <div class="container">
                            ...
                            <div class="navbar_top hidden-xs">
                                <div class="top_addr">
                                    <span><i class="fa fa-map-marker" aria-hidden="true"></i> Rua Vila Izabel, 155 - Curitiba - PR, CEP 80240-080.</span>
                                    <span><i class="fa fa-phone" aria-hidden="true"></i> (45) 9705 658</span>
                                        ...
                                        <div class="navbar-right">
                                            <ul class="nav navbar-nav">
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <li><a class="page-scroll" href="<?php echo site_url('registrar'); ?>">Registrar</a></li>
                            ...
                            <div class="footer_content">
                                <div class="row">
                                    <div class="col-sm-6 col-md-4">
                                        ...
                                        <p class="footer_txt">Café Emporium é um estabelecimento comercial popular especializado em pequenas refeições rápidas, lanches e sanduíches.
Em Curitiba-PR </p>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        ...
                                        <div class="footer_border">
                                            <div class="footer_cnt">
                                                ...
                                                <span>Rua Vila Izabel, 155 - Curitiba - PR, CEP 80240-080.</span>
                                            </div>
                                            <div class="footer_cnt">
                                                <i class="fa fa-phone"></i>
                                                <span>(45) 9705 658; (45) 570 321</span>
                                            </div>
                                            <div class="footer_cnt">
                                                <i class="fa fa-envelope"></i>
                                                <span>info@cafeemporium.net</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <nav class="cd-nav-container right_menu" id="cd-nav">
            <div class="header__open_menu">
                <a href="<?php echo site_url('/'); ?>" class="rmenu_logo" title="Café Emporium ">
                    <img src="<?php echo site_url('web/'); ?>src/assets/img/logo.png" alt="logo" />
                </a>
            </div>
